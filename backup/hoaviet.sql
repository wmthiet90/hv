...
--
-- Host: localhost
-- Generation Time: Jan 07, 2016 at 06:58 PM
...
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.68150002, 1, '2016-01-04 17:26:55'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2016-01-04 18:28:39'),
(3, 'Euro', 'EUR', '', '€', '2', 0.92739999, 1, '2016-01-04 17:26:55');
...
(28, 'Featured - Home Page', 'featured', 'a:6:{s:4:"name";s:20:"Featured - Home Page";s:7:"product";a:9:{i:0;s:2:"43";i:1;s:2:"40";i:2;s:2:"42";i:3;s:2:"44";i:4;s:2:"45";i:5;s:2:"41";i:6;s:2:"36";i:7;s:2:"34";i:8;s:2:"48";}s:5:"limit";s:1:"9";s:5:"width";s:3:"200";s:6:"height";s:3:"200";s:6:"status";s:1:"1";}'),
...
--
-- Dumping data for table `wm_product_attribute`
--

INSERT INTO `wm_product_attribute` (`product_id`, `attribute_id`, `language_id`, `text`) VALUES
(43, 2, 1, '1'),
(47, 4, 1, '16GB'),
(43, 4, 1, '8gb'),
(42, 3, 1, '100mhz'),
...
--
-- Dumping data for table `wm_product_discount`
--

INSERT INTO `wm_product_discount` (`product_discount_id`, `product_id`, `customer_group_id`, `quantity`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
--
-- Dumping data for table `wm_product_option`
--

INSERT INTO `wm_product_option` (`product_option_id`, `product_id`, `option_id`, `value`, `required`) VALUES
(224, 35, 11, '', 1),
...
--
-- Dumping data for table `wm_product_option_value`
--

INSERT INTO `wm_product_option_value` (`product_option_value_id`, `product_option_id`, `product_id`, `option_id`, `option_value_id`, `quantity`, `subtract`, `price`, `price_prefix`, `points`, `points_prefix`, `weight`, `weight_prefix`) VALUES
...
--
-- Dumping data for table `wm_product_reward`
--

INSERT INTO `wm_product_reward` (`product_reward_id`, `product_id`, `customer_group_id`, `points`) VALUES
(515, 42, 1, 100),
(519, 47, 1, 300),
(379, 28, 1, 400),
(329, 43, 1, 600),
...
--
-- Dumping data for table `wm_product_special`
--

INSERT INTO `wm_product_special` (`product_special_id`, `product_id`, `customer_group_id`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
--
-- Dumping data for table `wm_product_to_category`
--

INSERT INTO `wm_product_to_category` (`product_id`, `category_id`) VALUES
(28, 20),
(28, 24),
(29, 20),
(29, 24),
...
(367, 0, 'config', 'config_ftp_hostname', 'hoaviet.local', 0),
...
(297, 0, 'config', 'config_template', 'hoaviet', 0),
...
(288, 0, 'config', 'config_email', 'nvthiet.khtn08@gmail.com', 0),
...
(388, 0, 'config', 'config_encryption', '879e4cfd9175a6870e10ed98e3e7e38e', 0),
